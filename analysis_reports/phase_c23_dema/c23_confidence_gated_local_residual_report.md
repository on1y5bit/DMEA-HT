...
C23 freezes the complete C17 predictor and reads only its frozen latent pathological-mechanism interaction representation. The deterministic gate is largest near the C17 decision boundary and cannot use labels or shortcut fields.
