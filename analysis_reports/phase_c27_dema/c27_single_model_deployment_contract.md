...
Each seed is an independent architecture-stability replicate. Inference loads exactly one checkpoint, one model, and performs one forward pass. No predictions or checkpoint weights are combined.
